...
class Deal_Register_IndexController extends Mage_Core_Controller_Front_Action
{
    ...
    { 
     $this->loadLayout(array('default'));
      $this->getLayout()->getBlock('head')->setTitle('Login');
     $this->renderLayout();
    }
    public function memberAction()
    {
     ...
     $this->loadLayout(array('default'));
      $this->getLayout()->getBlock('head')->setTitle('Register');
     $this->renderLayout();
    }
    ...
    public function updateinfoAction()
    {
        ...
        if($data)
        {
            ...
            $registerdata->setstatus($data['status']);
            $registerdata->setvision($data['vision']);
             $registerdata->setwebsite($data['website']);
            $registerdata->setaboutme($data['about-me']);

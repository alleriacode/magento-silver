<?php
class Brst_Requestaffialiate_Block_Adminhtml_Approveaffialiate_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Init class
     */
    ...
    {  
        ...
        $this->setId('brst_requestaffialiate_approveaffialiate_form');

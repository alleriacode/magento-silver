<?php
class Brst_Requestaffialiate_Adminhtml_AffialiateController extends Mage_Adminhtml_Controller_Action
{
    ...
    {  
      ...
      $id  = $this->getRequest()->getParam('id');
        ...
        $model = Mage::getModel('brst_requestaffialiate/affialiate');
    ...
    //  echo "<pre>";print_r($data);die('fhfh');
        ...
        $this->_initAction()
            ...
            ->_addContent($this->getLayout()->createBlock('brst_requestaffialiate/adminhtml_affialiate_edit')->setData('action', $this->getUrl('*/*/save')))
            ->renderLayout();
    }
     ...
     // print_r($_POST);
       //die("herrre");
        if ($postData = $this->getRequest()->getPost()) {
            $model = Mage::getSingleton('brst_requestaffialiate/affialiate');
       ...
       public function deleteAction()
    {
        ...
        $affiliate =Mage::getSingleton('brst_requestaffialiate/affialiate')->load($affiliateId);
    ...
    {
        $data = Mage::getModel('brst_requestaffialiate/affialiate')->load($this->getRequest()->getParam('id'));
    ...
    protected function _initAction()
    {
        $this->loadLayout()
            ...
            ->_setActiveMenu('sales/brst_requestaffialiate_affialiate')
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('sales/brst_requestaffialiate_affialiate');
    }
}
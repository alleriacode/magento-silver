...
class Brst_Member_Adminhtml_PaymentController extends Mage_Adminhtml_Controller_Action
{
    ...
    */
    ...
    public function createAction()
    {
        ...
        //$ExternalLibPath=Mage::getModuleDir('local', 'Brst_Member') . DS .'Excel';
        $url = getcwd().'/reportsfiles/aggregate.txt';
        //$myFile = $ExternalLibPath.'/'.'aggregate.txt';
        ...
        $this->_getSession()->addSuccess($this->__('Email sent successfully to the member.'));
        $this->_redirect('*/*');
    }

...
class FME_Events_Helper_Calendar extends Mage_Core_Helper_Abstract
{
    ...
    public function drawCalendar($month,$year)
    {
        ...
        for($list_day = 1; $list_day <= $days_in_month; $list_day++):
            ...
            {
                 $calendar.= '<div class="day-number1" style="color:red;"><a href="'.Mage::helper('events')->customUrl($dateString).'">'.$list_day.'</a></div>';
                $title = '&nbsp;';
                $links = '';
                $pfx = '';
            ...
            {
                $calendar.= '<div class="day-number" style="color:red;"><a href="'.Mage::helper('events')->customUrl($dateString).'">'.$list_day.'</a></div>'; //$calendar.= '<p>&nbsp;</p>';
            }
